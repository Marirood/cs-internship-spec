...
## مقدمه
در این مستند به معرفی پیش‌نیازها و بخش‌هایی از فرآیندهای اصلی برنامه CS Internship که لازم است قبل از ورود به برنامه با آنها آشنا باشید می‌پردازیم. با باقی فرآیند‌های برنامه بعد از جلسه مصاحبه در فرآیند آنبوردینگ آشنا خواهید شد.
...
برنامه CS Internship کاملاً به صورت ریموت برگزار می‌شود و اساسا از ابتدا به طریقی طراحی شده است تا شرکت‌کنندگان را برای کار در تیم‌های ریموت ایرانی و خارجی آماده کند. برای ورود به برنامه، افراد به یک کامپیوتر مناسب برای برنامه‌نویسی و یک خط اینترنت که از پهنای باند لازم برای شرکت در جلسات تصویری برخوردار است، نیاز دارند.
...
تمامی ارتباطات رسمی برنامه CS Internship از طریق گروه‌ها و کانال‌های اختصاصی تلگرامی انجام می‌شود. پس از ورود به برنامه، شما به این گروه‌ها اضافه خواهید شد و با نحوه فعالیت و تعامل در آن‌ها آشنا خواهید شد.
توجه داشته باشید که تنها گفتگوها و هماهنگی‌هایی که در این گروه‌ها انجام می‌شوند، رسمی بوده و در چارچوب برنامه قابل پیگیری هستند.
...
**دوره وب**: در این دوره با JavaScript، CSS، Html و TypeScript آشنا می‌شوید و نهایتا بصورت خیلی کلی با فریم‌ورک‌های این حوزه آشنایی پیدا می‌کنید. برای اطلاعات بیشتر می‌توانید [گام‌های دوره وب](https://github.com/cs-internship/cs-internship-spec/tree/master/courses/web) را ببینید.

**دوره یادگیری‌ ماشین**: دوره ماشین لرنینگ شامل سه مرحله اصلی است: مبانی زبان پایتون، مبانی علوم داده با ابزارهایی مانند Matplotlib ،Numpy و Pandas، و مبانی ماشین لرنینگ با تمرکز بر الگوریتم‌ها و مفاهیم ریاضی. این دوره مهارت‌های لازم برای تحلیل داده و ایجاد مدل‌های اولیه را ارائه می‌دهد. برای اطلاعات بیشتر می‌توانید [گام‌های دوره یادگیری ماشین](https://github.com/cs-internship/cs-internship-spec/tree/master/courses/Machine%20Learning) را ببینید.
